...
function Scene(c) {
  ...
  this.initialize = function() {
    Scene.prototype.initialize.apply(this, arguments),
      ...
      this.paintAll = !1;
    let c = 'background,backgroundColor,mode,paintAll,areaSelect,translate,translateX,translateY,lastTranslatedX,lastTranslatedY,alpha,visible,scaleX,scaleY'.split(',');
    ...
    this.paint = function(a) {
      if (0 != this.visible && null != this.stage) {
        if (a.save(), this.paintBackgroud(a), a.restore(), a.save(), a.scale(this.scaleX, this.scaleY), 1 == this.translate) {
          let b = this.getOffsetTranslate(a);
    ...
    this.selectElement = function(a) {
      let b = e.getElementByXY(a.x, a.y);
      if (null != b) {
    ...
    this.mousemoveHandler = function(b) {
      ...
      let d = e.getElementByXY(c.x, c.y);
  ...
  let f = 'click,dbclick,mousedown,mouseup,mouseover,mouseout,mousemove,mousedrag,mousewheel,touchstart,touchmove,touchend,keydown,keyup'.split(','),
    g = this;
