  ...
  this.initialize = function(c) {
    ...
    this.paint = function(a) {
      if (this.image) {
        ...
        null == this.borderRadius || 0 == this.borderRadius ? a.rect(- this.width / 2, -this.height / 2, this.width, this.height) : a.AmostRoundRect(- this.width / 2, -this.height / 2, this.width, this.height, this.borderRadius),
        a.fill(),
        a.closePath();}
      this.paintText(a),
        this.paintBorder(a),
    ...
    this.paintBorder = function(a) {
      if (0 != this.borderWidth) {
        ...
        null == this.borderRadius || 0 == this.borderRadius ? a.rect(- this.width / 2 - b, -this.height / 2 - b, this.width + this.borderWidth, this.height + this.borderWidth) : a.AmostRoundRect(- this.width / 2 - b, -this.height / 2 - b, this.width + this.borderWidth, this.height + this.borderWidth, this.borderRadius),
          a.stroke(),
          a.closePath();
      }
    },
