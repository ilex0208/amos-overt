  ...
  q.forEach(function(a) {
    ...
    setTimeout(function() {
      n.mousewheel(function(a) {
        ...
        null != this.wheelZoom && (Util.isChrome ? (b > 0 ? this.zoomOut(this.wheelZoom) : this.zoomIn(this.wheelZoom)) : (b > 0 ? this.zoomIn(this.wheelZoom) : this.zoomOut(this.wheelZoom)));
      }),
        n.paint();
    },
      300),
