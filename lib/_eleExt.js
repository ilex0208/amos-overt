    ...
    this.mousedragHandler = function(msg) {
      if (null == this.selectedPoint) {
        ...
        if ('Top_Left' == this.selectedPoint) {
          let d = this.selectedSize.width - msg.dx,
            e = this.selectedSize.height - msg.dy,
            b = this.selectedLocation.x + msg.dx,
            c = this.selectedLocation.y + msg.dy;
          ...
          let e = this.selectedSize.height - msg.dy,
            c = this.selectedLocation.y + msg.dy;
          c < this.y + this.height && (this.y = c, this.height = e);
        } else if ('Top_Right' == this.selectedPoint) {
          let d = this.selectedSize.width + msg.dx,
            c = this.selectedLocation.y + msg.dy;
          c < this.y + this.height && (this.y = c, this.height = this.selectedSize.height - msg.dy),
          d > 1 && (this.width = d);
